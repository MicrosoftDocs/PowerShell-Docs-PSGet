...
[Install-PSResource](../Microsoft.PowerShell.PSResourceGet/Install-PSResource.md).
...
The proxy cmdlet transform the value of this parameter to the **NoClobber** parameter of the
