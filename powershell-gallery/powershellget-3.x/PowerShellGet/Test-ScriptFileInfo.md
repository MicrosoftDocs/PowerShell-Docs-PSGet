...
ms.date: 09/19/2023
online version: https://learn.microsoft.com/powershell/module/powershellget/test-scriptfileinfo?view=powershellget-2.x&WT.mc_id=ps-gethelp
schema: 2.0.0
...
This is a proxy cmdlet for the `Test-PSScriptFileInfo` cmdlet in the
**Microsoft.PowerShell.PSResourceGet**. For more information, see
[Test-PSScriptFileInfo](../Microsoft.PowerShell.PSResourceGet/Test-PSScriptFileInfo.md).
...
The parameter is mapped to the **Path** parameter of `Test-PSScriptFileInfo`.
