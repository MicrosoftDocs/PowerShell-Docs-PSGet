...
ms.custom: v3-beta21
ms.date: 05/11/2023
online version: https://learn.microsoft.com/powershell/module/powershellget/update-modulemanifest?view=powershellget-3.x&WT.mc_id=ps-gethelp
schema: 2.0.0
---
...
Update-ModuleManifest [-Path] <String> [-NestedModules <Object[]>] [-Guid <Guid>]
 ...
 [-RequireLicenseAcceptance] [-PrivateData <Hashtable>]
 [<CommonParameters>]
```
