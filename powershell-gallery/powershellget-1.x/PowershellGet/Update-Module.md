...
ms.date: 01/17/2023
online version: https://learn.microsoft.com/powershell/module/powershellget/update-module?view=powershellget-1.x&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Update-Module
---
# Update-Module
...
Windows PowerShell includes the following aliases for `Update-Module`:
